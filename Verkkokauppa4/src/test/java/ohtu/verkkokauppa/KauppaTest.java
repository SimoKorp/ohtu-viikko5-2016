...
public class KauppaTest {
    ...
    public void KaksiOstostaEri() {
        ...
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        when(varasto.haeTuote(2)).thenReturn(new Tuote(2, "vesi", 3));
    ...
    @Test
    public void YksiOnnistunutYksiEpäonnistunut() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void viiteKutsuuSeuraavan() {
        // luodaan ensin mock-oliot
        ...
        // sitten testattava kauppa 
        Kauppa kauppa = new Kauppa(varasto, mockPankki, mockViite);
    ...
    @Test
    public void YksiOnnistunutYksiPoistettu() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
        ...
        when(varasto.saldo(2)).thenReturn(10);
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        when(varasto.haeTuote(2)).thenReturn(new Tuote(1, "vesi", 3));
